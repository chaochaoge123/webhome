...
from blog.views import UserList, TimeTest, WxCallBack, AliCallBack, AliReturn, DownloadFile, UploadFile
...
urlpatterns += [
    url(r'^api/v1/user/list/', UserList.as_view(), name='user-list-data'),
    url(r'^api/v1/time/', TimeTest.as_view(), name='time-test-data'),
    url(r'^api/wx/pay/callback/', WxCallBack.as_view(), name='wx-callback'),
    url(r'^api/ali/pay/callback/', AliCallBack.as_view(), name='ali-callback'),
    url(r'^api/ali/pay/return/', AliReturn.as_view(), name='ali-callback-return'),
    url(r'^api/file/download/', DownloadFile.as_view(), name='file-download'),
    url(r'^api/file/upload/', UploadFile.as_view(), name='file-upload')
]