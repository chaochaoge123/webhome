...
class Article(models.Model):
    ...
    content = MDTextField(verbose_name=u'正文')  # 前端展示的样式
    bef_content = MDTextField(default='', verbose_name=u'编辑正文')  #后台编辑的样式
...
#     id = models.AutoField(auto_created=True, primary_key=True, verbose_name=u'ID')
#     params = models.CharField(default='', max_length=2280, verbose_name=u'请求参数')
#     path = models.CharField(default='', max_length=128, verbose_name=u'请求url')
#     user_ip = models.CharField(default='', db_index=True, max_length=128, verbose_name=u'ip地址')
#     response_data = models.CharField(default='', max_length=2228, verbose_name=u'响应信息')
#     state = models.PositiveSmallIntegerField(default=0, verbose_name=u'记录状态 0-上线 1-下线 9-删除')
