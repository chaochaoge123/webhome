...
STATIC_ROOT = BASE_DIR + '/static/'   # 在nginx中配置此目录，由nginx处理静态资源
...
EMAIL_SUBJECT_PREFIX = u'qqc-nome'       # 为邮件Subject-line前缀,默认是'[django]'
...
# 网站标题等内容配置
WEBSITE_TITLE = u'qqc-home'
WEBSITE_WELCOME = u'欢迎来到qqc-home !!!'
